...
class BatchExamCategory extends Model
{
    ...
    public static function createOrUpdateCourseCategory($request, $id = null)
    {
        BatchExamCategory::updateOrCreate(['id' => $id], [
            ...
            'note'          => $request->note,
            'image'         => isset($id) ? imageUpload($request->file('image'), 'batch-exam/batch-exam-category-images/', 'batch-exam-category', '320', '200', static::find($id)->image) : imageUpload($request->file('image'), 'batch-exam/batch-exam-category-images/', 'batch-exam-category', '320', '200'),
