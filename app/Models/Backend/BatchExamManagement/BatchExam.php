...
//        self::$batchExam->price                    = $request->price;
        self::$batchExam->banner                   = isset($id) ? imageUpload($request->file('banner'), 'batch-exam/batch-exam-banners/', 'batch-exams', '320', '200', static::find($id)->banner) : imageUpload($request->file('banner'), 'batch-exam/batch-exam-banners/', 'batch-exams', '320', '200');
