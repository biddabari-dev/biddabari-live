...
{{--                    </select>--}}
                ...
                <div class="col-md-12 mt-2 mb-2">
                    ...
                    <textarea name="description" class="form-control" id="summernote" placeholder="Course Description" cols="30" rows="5">sssssssssssssssss{!! isset($course) ? $course->description : '' !!}</textarea>
