                    ...
                    <div class="header-left">
                        <ul>
                            ...
                            <li class="bg-danger">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.nextive.biddabari2021&pcampaignid=web_share" target="_blank"><span class="__cf_email__">Install Biddabari App</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
